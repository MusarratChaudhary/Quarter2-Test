...
function page() {
  return (
    <>
    <div className='container mx-auto h-[2200px] w-[1440px] main-color'>
        ...
        <div className='h-[1000px] w-[1440px] main-color'>
            ...
            <div className='flex mt-20 ml-10'>
                ...
                <div className='mt-28 ml-28'>
                    <h1>Your name</h1>
                      <button className='h-10 w-60 border-[1px] border-gray-400 rounded-md cursor-text text-gray-300 font-light'>abc</button>
                    <h1 className='mt-5'>Email address</h1>
                      <button className='h-10 w-60 border-[1px] border-gray-400 rounded-md mt-2 cursor-text text-gray-300 font-light'>abc@gmail.com</button>
                    <h1 className='mt-5'>Subject</h1>
                      <button className='h-10 w-60 border-[1px] border-gray-400 rounded-md cursor-text text-gray-300 font-light'>This is an optional</button>
                    <h1 className='mt-5'>message</h1>
                      <button className='h-20 w-60 border-[1px] border-gray-400 rounded-md mt-2 cursor-text'></button>
                      <div>
                      <button className='h-10 w-40 border-[1px] border-gray-500 mt-8 text-center content-center rounded-xl hover:bg-slate-200'>Submit</button>
                      </div>
                </div>
            </div>
        </div>
